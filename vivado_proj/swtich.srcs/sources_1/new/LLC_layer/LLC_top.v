...
arbiter arbiter_inst(
    ...
    .mac_choose (mac_choose),        //MAC选择信号input wire [2:0] 

	//--------------------------------rx_fifo相关接口-----------------------------------
    .mac_rx_fifo_dout           (mac_rx_fifo_dout),//输出MAC fifo 存储数据         input wire [63:0] [7:0]
	...
	.mac_tx_fifo_din         (mac_tx_fifo_din),//tx_fifo写数据  output wire [63:0]  [7:0]
