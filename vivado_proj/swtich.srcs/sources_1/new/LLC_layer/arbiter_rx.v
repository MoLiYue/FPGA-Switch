module arbiter_rx(
    ...
    //------------------------rx_que_fifo相关接口-----------------------------
	input wire [17:0] 	mac_rx_que_fifo_dout			[7:0],//输出数据
	input wire 			mac_rx_que_fifo_empty			[7:0],	//读空信号
	input wire 			mac_rx_que_fifo_almost_empty	[7:0],		//读将空信号
	input wire 			mac_rx_que_fifo_underflow		[7:0],	//读溢出信号

	output wire 		mac_rx_que_fifo_rd_en			[7:0]   //读使能
