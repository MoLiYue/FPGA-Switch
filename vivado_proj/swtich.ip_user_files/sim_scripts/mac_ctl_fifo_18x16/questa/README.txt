...
#
# Generated by export_simulation on Sat May 28 14:03:40 CST 2022
#
################################################################################
...
'-reset_run' switch to the './mac_ctl_fifo_18x16.sh' script.

./mac_ctl_fifo_18x16.sh -reset_run
...
./mac_ctl_fifo_18x16.sh -noclean_files

For more information on the script, please type './mac_ctl_fifo_18x16.sh -help'.
