...
#
# Generated by export_simulation on Mon Apr 04 16:58:42 CST 2022
#
################################################################################
...
'-reset_run' switch to the './mac_reg_12x32.sh' script.

./mac_reg_12x32.sh -reset_run
...
./mac_reg_12x32.sh -noclean_files

For more information on the script, please type './mac_reg_12x32.sh -help'.
