...
#
# Generated by export_simulation on Sat May 28 16:25:17 CST 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_64x1000.sh' script.

./blk_mem_64x1000.sh -reset_run
...
./blk_mem_64x1000.sh -noclean_files

For more information on the script, please type './blk_mem_64x1000.sh -help'.
