...
HD_PWD='/home/mlyue/Documents/FPGA_A7/Switch/vivado_proj/swtich.runs/pll_mac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_mac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_mac.tcl
